...
function render (parsedData, firstTitleData, secondTitleData, thirdTitleData, fourthTitleData) {
  var source = readFile("./lib/html/definitionMode.html","UTF8");
  ...
  var title = parsedData.query.random[randomSelectedId].title;

  var info = {
    "selectedTitle": title,
    "selectedId" : randomSelectedId,
    "option1": firstTitleData.query.pages[firstTitleId].extract,
    "option2": secondTitleData.query.pages[secondTitleId].extract,
    "option3": thirdTitleData.query.pages[thirdTitleId].extract,
    "option4": fourthTitleData.query.pages[fourthTitleId].extract,
  };
