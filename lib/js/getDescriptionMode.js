...
function render (parsedData, firstTitleData, secondTitleData, thirdTitleData, fourthTitleData) {
  ...
  var info = {
    ...
    "option3": thirdTitleData.query.pages[thirdTitleId].extract.replace(thirdTitleData.query.pages[thirdTitleId], "ANSWER"),
    "option4": fourthTitleData.query.pages[fourthTitleId].extract.replace(fourthTitleData.query.pages[fourthTitleId], "ANSWER")
  };
